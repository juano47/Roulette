...
int main() {
	...
	case 2: system("cls"); 
		...
		system("cls"); 
		break;
	case 3: menuRangos(tl, vector36, vector);
		system("cls");
		break;
	case 4:system("cls");
		cargarVector36(vector, vector36, 0, tl);
	...
	case 5:system("cls");
		...
		system("cls");
		break;
	case 6: if (Salir()){ // si deseaSalir es verdadera, entonces no se debe continuar con la ejecucion del programa.
			continuarMenu = false;
		}
		break;
	}
