//ruleta v7  agrega ANALISIS MANUAL
...
int main() {
	...
	do{
		do{	
			...
			cout<<"\t\t\t\t      ฬออออออออออออออออออออออออออออออออออออน"<<endl;
			cout<<"\t\t\t\t      บ11.ZONAS OPTIMAS                    บ"<<endl;
			cout<<"\t\t\t\t      ฬออออออออออออออออออออออออออออออออออออน"<<endl;
			cout<<"\t\t\t\t      บ12.ANALISIS MANUAL                  บ"<<endl;
			cout<<"\t\t\t\t      ฬออออออออออออออออออออออออออออออออออออน"<<endl;
			cout<<"\t\t\t\t      บ13.SALIR                            บ"<<endl;
			...
			cin.clear ();
			fflush(stdin);
			if(entrar<1||entrar>13) {
				system("cls");
				cout<<"\t\t\aError: la seleccion solo puede ser 1 a 13. Reingrese por favor"<<endl;
			}
			
		} while(entrar<1||entrar>13);
		...
		case 12: //ANALISIS MANUAL
			...
			system("cls");
			break;
		case 13: if (Salir()){ // si deseaSalir es verdadera, entonces no se debe continuar con la ejecucion del programa.
			continuarMenu = false;
		}
			break;
		}
...
void analisisManual(int vector36[], int vector[], int tl){
	...
	while((cantNumeros+contador+cantJugadas)<=tl){
		...
		if((contador%45)==0)	//va mostrando de a 45 valores por pantalla y pausando
			system("pause");
	...
	cout<<"CANTIDAD DE CEROS ->\t"<<cantCero<<endl<<endl;
	cout<<"CANTIDAD DE UNOS ->\t"<<cantUno<<endl<<endl;
	cout<<"CANTIDAD DE DOS ->\t"<<cantDos<<endl<<endl;
	cout<<"CANTIDAD DE TRES ->\t"<<cantTres<<endl<<endl;
	cout<<"CANTIDAD DE CUATRO ->\t"<<cantCuatro<<endl<<endl;
	cout<<"CANTIDAD DE CINCO ->\t"<<cantCinco<<endl<<endl;
	cout<<"CANTIDAD DE SEIS ->\t"<<cantSeis<<endl<<endl;
	cout<<"CANTIDAD DE SIETE ->\t"<<cantSiete<<endl<<endl;
	Sleep(1500);
	system("pause");
}
bool Salir(){
